...
use EMS\ClientHelperBundle\EMSBackendBridgeBundle\Helper\File\FileInfo;
...
class FileController extends AbstractController
{
    ...
    public function assetAction(Request $request, string $sha1)
    {
        ...
        $info = new FileInfo($filename, $mimetype, $sha1);
     ...
     * @return BinaryFileResponse|Response
     */
    private function fileResponseCache(FileInfo $info, Request $request)
    {
     ...
     */
    private function fileResponse(FileInfo $info)
    {
